...
will need to configure the Archivematica and Storage Service API parameters
via `reingestconfig.json` as they will be used to make calls to the
Archivematica Client module `amclient.py` documented above. An example with
placeholder parameters is provided in the transfers examples folder:
